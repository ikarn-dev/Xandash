        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 bg-emerald-500/20 border border-emerald-500/30 rounded-full flex items-center justify-center">
              <CalculatorIcon className="w-7 h-7 text-emerald-400" />
            </div>
            <div>
              <div className="flex items-center gap-3 flex-wrap">
                <h1 className="text-2xl font-bold text-white">STOINC Calculator</h1>
                <span className="px-2 py-0.5 bg-emerald-500/20 border border-emerald-500/30 rounded text-emerald-400 text-xs">Storage Income</span>
              </div>
              <p className="text-white/60 text-sm mt-1">Calculate your potential earnings from running pNodes</p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-end gap-1">
            <div className="flex items-center gap-2 text-emerald-400">
              ...
              <span className="text-sm font-mono">Real-time Calculation</span>
            </div>
            <span className="text-white/40 text-xs">Updated every epoch (~2 days)</span>
          </div>
        </div>
      </div>
